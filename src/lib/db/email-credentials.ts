...
// SMTP 模式：smtp_host / smtp_port / smtp_username / smtp_password_ciphertext / from_email
export async function saveEmailCredential(
  ...
  await db
    .prepare(
      `INSERT INTO email_credentials (id, smtp_host, smtp_port, smtp_username, smtp_password_ciphertext, encryption_key_version, from_email, api_url, api_key_ciphertext, updated_at)
